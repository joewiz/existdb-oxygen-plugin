...
public final class LangServiceSupport {
  ...
  /**
   * Keeps proposals whose label starts with {@code prefix} (case-insensitive); falls back to the
   * full list when the prefix is empty or nothing matches. Client-side scoping because the endpoint
   * returns the whole function library (existdb-openapi issue #31).
   */
  public static List<ExistClient.Completion> filterByPrefix(
